...
Given a sequence $a_1$, $a_2$, ..., $a_{2021}$ satisfying $a_1a_2 \cdots a_{2021} = 2021$, and $a_{i} \in \mathbb{R}^+ \; \forall i \in \{1, 2, \cdots, 2021\}$, what is the minimum of $\sum_{i = 1}^{2021} a_i$?
